...
class Unet(nn.Module):
    def __init__(self, in_channels=1, out_channels=2, init_features=32):
        ...
        # defines the Unet structure as a 4 layer (+ bottleneck) deep system
        ...
        self.conv = nn.Conv2d(in_channels=features, out_channels=out_channels, kernel_size=1)  # output
    ...
    @staticmethod
    def _block(in_channels, features, name):  # defines one block in the U-Net
